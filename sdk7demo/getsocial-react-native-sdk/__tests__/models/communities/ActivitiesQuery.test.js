...
const jsonResult2 = '{"ids":{"ids":["test"],"type":4},"tag":"tag","pollStatus":0}';
...
const topicJsonResult = '{"ids":{"ids":["topicId"],"type":2},"pollStatus":0}';
...
const topicJsonResult2 = '{"ids":{"ids":["topicId"],"type":2},"author":{"userId":"test"},"pollStatus":0}';
...
const allTopicsJsonResult = '{"ids":{"ids":[],"type":2},"pollStatus":0}';
...
const groupsJsonResult = '{"ids":{"ids":["groupId"],"type":3},"pollStatus":0}';
...
const timelineJsonResult = '{"ids":{"ids":["timeline"],"type":1},"pollStatus":0}';
...
const everywhereJsonResult = '{"ids":{"ids":[]},"pollStatus":0}';
...
const commentsJsonResult = '{"ids":{"ids":["activityId"],"type":6},"pollStatus":0}';
