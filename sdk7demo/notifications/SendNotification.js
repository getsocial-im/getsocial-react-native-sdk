...
export default class SendNotification extends Component<Props, State> {
    ...
    sendNotification = async () => {
      ...
      var notification = this.state.templateName == null ? NotificationContent.withText(this.state.notificationText == null ? '' : this.state.notificationText) : NotificationContent.withTemplate(this.state.templateName);
      ...
      var notificationTarget = SendNotificationTarget.usersWithIds(UserIdList.create(recipients));
      ...
      if (this.state.backgroundImage != null || this.state.titleColor != null || this.state.textColor != null) {
        var customization = NotificationCustomization.create();
