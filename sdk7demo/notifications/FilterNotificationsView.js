...
import {Platform, Modal, View, Text, FlatList, ScrollView, TextInput, Button} from 'react-native';
          ...
          <FlatList style={{flex: 1}}
            ...
            renderItem={({item, index}) => (
              <View style={FilterNotificationsViewStyle.formEntryRow}>
                ...
                <CheckBox center value={item.checked} onValueChange={() => this.updateStatusFilterCheckbox(index)}/>
              </View>
            )}
          ...
          <FlatList style={{flex: 1}}
            ...
            renderItem={({item, index}) => (
              <View style={FilterNotificationsViewStyle.formEntryRow}>
                ...
                <CheckBox center value={item.checked} onValueChange={() => this.updateTypeFilterCheckbox(index)}/>
              </View>
            )}
            keyExtractor={(item) => item.key}
          />
